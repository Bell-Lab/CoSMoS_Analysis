...
plot(time,(NexpTexp3-NbTb4)*CorrectionFactor_exp3*(a_exp3*exp(-time*r1_3)+(1-a_exp3)*exp(-time*r2_3))+NbTb4*CorrectionFactor_Bkgnd4*(ab4*exp(-time*tau1_4)+(1-ab4)*exp(-time*tau2_4)),'g');
% (OBSERVED nonDNA freq) )*(correction factor)*(2exp term)
